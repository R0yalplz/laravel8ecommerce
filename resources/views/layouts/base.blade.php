...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{asset('assets/css/rest.css')}}">
...
<body class="home-page home-01 ">
	...
	<script src="{{asset('assets/js/mess.js')}}"></script>
	...
	<script src="https://cdn.tiny.cloud/1/51urjyl9pbgbeywmwi8swurc41xi1whb3l6uzbmqc1x038bn/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
	@livewireScripts
